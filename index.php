...
<script>
	$(document).ready(function() {
		...
		/*	$('.closing-x button').click(function() {
				$('.cart').animate({
					width: 'toggle'
				});
			});
	...
	<div class="container text-right">
		<div class="row marathon">
			<div class="col-md-6 marathon-left p-5 gradient-bg">
				...
				<p><a href="marathonsignup"><button class="actual-button bg-dark text-white">I WANT TO RACE <strong class="material-icons hoverable-icons">navigate_next</strong></button></a></p>
			</div>
			...
			<div class="col">
				...
				<div>
					...
					<div class="row">
						...
						<div class="col-auto">
							<strong class="material-icons ">star</strong>
							<strong class="material-icons ">star</strong>
							<strong class="material-icons ">star</strong>
							<strong class="material-icons ">star</strong>
							<strong class="material-icons ">star_half</strong>
						</div>
					</div>
				</div>
			</div>
